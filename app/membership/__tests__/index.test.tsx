...
// Bu süit Android/web davranışını doğruluyor: fiyat tablosu + dönem geçişi
// orada duruyor. jest-expo varsayılanı `ios` olduğu için CAN_BUY_DIGITAL'ı
// modül seviyesinde sabitliyoruz (bkz. ios-membership-screen.test.tsx).
